...
function handleTap(e){
  ...
  // Must tap directly on the zombie's body
  ...
  for(var i=0;i<zombies.length;i++){
    ...
    var zw=zh*0.5;
    var zcx=z.x, zcy=z.y-zh/2; // body center
    // Check if tap is inside the zombie's body rectangle
    if(tx>=zcx-zw/2 && tx<=zcx+zw/2 && ty>=zcy-zh/2 && ty<=zcy+zh/2){
